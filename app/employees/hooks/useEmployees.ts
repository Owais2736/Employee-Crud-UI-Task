...
{ id: uuidv4(), name: 'Faraz Khan', email: 'faraz@gmail.com', role: 'Developer', status: true },
{ id: uuidv4(), name: 'Bilal Ahmed', email: 'bilal@gmail.com', role: 'Lead', status: true },
{ id: uuidv4(), name: 'Sara Ali', email: 'sara@gmail.com', role: 'Designer', status: false },
]
...
useEffect(() => {
try {
localStorage.setItem(localStorageEmployeeObject, JSON.stringify(employees))
} catch (e) {
...
setEmployees(prev => prev.map(e => (e.id === id ? { id, ...payload } : e)))
}
